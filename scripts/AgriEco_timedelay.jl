...
let 
    revexpcurve108_lowymax_timedelay_data33to08 = prepDataFrame(terminalassets_timedelay_rednoise_dataset_CV(revexpcurve_vals[2][1,:], EconomicPar(), CV_timedelay, corrrange_timedelay, yearsdelay, minfraction, maxyears_timedelay, reps_timedelay))
    CSV.write(joinpath(abpath(), "data/revexpcurve108_lowymax_timedelay_data33to08.csv"), revexpcurve108_lowymax_timedelay_data33to08)
    revexpcurve108_medymax_timedelay_data33to08 = prepDataFrame(terminalassets_timedelay_rednoise_dataset_CV(revexpcurve_vals[2][2,:], EconomicPar(), CV_timedelay, corrrange_timedelay, yearsdelay, minfraction, maxyears_timedelay, reps_timedelay))
    CSV.write(joinpath(abpath(), "data/revexpcurve108_medymax_timedelay_data33to08.csv"), revexpcurve108_medymax_timedelay_data33to08)
    revexpcurve108_highymax_timedelay_data33to08 = prepDataFrame(terminalassets_timedelay_rednoise_dataset_CV(revexpcurve_vals[2][3,:], EconomicPar(), CV_timedelay, corrrange_timedelay, yearsdelay, minfraction, maxyears_timedelay, reps_timedelay))
    CSV.write(joinpath(abpath(), "data/revexpcurve108_highymax_timedelay_data33to08.csv"), revexpcurve108_highymax_timedelay_data33to08)
end

#Rev/Exp = 1.33 - along the curve
let 
    revexpcurve133_lowymax_timedelay_data33to08 = prepDataFrame(terminalassets_timedelay_rednoise_dataset_CV(revexpcurve_vals[4][1,:], EconomicPar(), CV_timedelay, corrrange_timedelay, yearsdelay, minfraction, maxyears_timedelay, reps_timedelay))
    CSV.write(joinpath(abpath(), "data/revexpcurve133_lowymax_timedelay_data33to08.csv"), revexpcurve133_lowymax_timedelay_data33to08)
    revexpcurve133_medymax_timedelay_data33to08 = prepDataFrame(terminalassets_timedelay_rednoise_dataset_CV(revexpcurve_vals[4][2,:], EconomicPar(), CV_timedelay, corrrange_timedelay, yearsdelay, minfraction, maxyears_timedelay, reps_timedelay))
    CSV.write(joinpath(abpath(), "data/revexpcurve133_medymax_timedelay_data33to08.csv"), revexpcurve133_medymax_timedelay_data33to08)
    revexpcurve133_highymax_timedelay_data33to08 = prepDataFrame(terminalassets_timedelay_rednoise_dataset_CV(revexpcurve_vals[4][3,:], EconomicPar(), CV_timedelay, corrrange_timedelay, yearsdelay, minfraction, maxyears_timedelay, reps_timedelay))
    CSV.write(joinpath(abpath(), "data/revexpcurve133_highymax_timedelay_data33to08.csv"), revexpcurve133_highymax_timedelay_data33to08)
end
