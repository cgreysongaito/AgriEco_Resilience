...
function finalassets_distribution_CV(NL, inputsyield, economicpar, noiseparCV, interestpar, maxyears, reps)
...
function finalassets_posfeed_rednoise_dataset_CV(YmaxI0vals, economicpar, interestpar, yielddisturbance_CV, corrrange, maxyears, reps)
    ...
    @threads for ri in eachindex(corrrange)
        ...
        data[ri, 1] = finalassets_distribution_CV("with", defaultinputsyield, economicpar, noiseparCV, interestpar, maxyears, reps)
        data[ri, 2] = finalassets_distribution_CV("without", defaultinputsyield, economicpar, noiseparCV, interestpar, maxyears, reps)
    end
...
let 
    OERatiocurve071_lowymax_posfeed_data = prepDataFrame(finalassets_posfeed_rednoise_dataset_CV(OERatiocurve_vals[1][1,:], EconomicPar(), InterestPar(), CV_posfeed, corrrange_posfeed, maxyears_posfeed, reps_posfeed))
    CSV.write(joinpath(abpath(), "data/OERatiocurve071_lowymax_posfeed_data.csv"), OERatiocurve071_lowymax_posfeed_data)
    OERatiocurve071_medymax_posfeed_data = prepDataFrame(finalassets_posfeed_rednoise_dataset_CV(OERatiocurve_vals[1][2,:], EconomicPar(), InterestPar(), CV_posfeed, corrrange_posfeed, maxyears_posfeed, reps_posfeed))
    CSV.write(joinpath(abpath(), "data/OERatiocurve071_medymax_posfeed_data.csv"), OERatiocurve071_medymax_posfeed_data)
    OERatiocurve071_highymax_posfeed_data = prepDataFrame(finalassets_posfeed_rednoise_dataset_CV(OERatiocurve_vals[1][3,:], EconomicPar(), InterestPar(), CV_posfeed, corrrange_posfeed, maxyears_posfeed, reps_posfeed))
...
let 
    OERatiocurve09_lowymax_posfeed_data = prepDataFrame(finalassets_posfeed_rednoise_dataset_CV(OERatiocurve_vals[2][1,:], EconomicPar(), InterestPar(), CV_posfeed, corrrange_posfeed, maxyears_posfeed, reps_posfeed))
    CSV.write(joinpath(abpath(), "data/OERatiocurve09_lowymax_posfeed_data.csv"), OERatiocurve09_lowymax_posfeed_data)
    OERatiocurve09_medymax_posfeed_data = prepDataFrame(finalassets_posfeed_rednoise_dataset_CV(OERatiocurve_vals[2][2,:], EconomicPar(), InterestPar(), CV_posfeed, corrrange_posfeed, maxyears_posfeed, reps_posfeed))
    CSV.write(joinpath(abpath(), "data/OERatiocurve09_medymax_posfeed_data.csv"), OERatiocurve09_medymax_posfeed_data)
    OERatiocurve09_highymax_posfeed_data = prepDataFrame(finalassets_posfeed_rednoise_dataset_CV(OERatiocurve_vals[2][3,:], EconomicPar(), InterestPar(), CV_posfeed, corrrange_posfeed, maxyears_posfeed, reps_posfeed))
...
let 
    OERatiocurve099_lowymax_posfeed_data = prepDataFrame(finalassets_posfeed_rednoise_dataset_CV(OERatiocurve_vals[3][1,:], EconomicPar(), InterestPar(), CV_posfeed, corrrange_posfeed, maxyears_posfeed, reps_posfeed))
    CSV.write(joinpath(abpath(), "data/OERatiocurve099_lowymax_posfeed_data.csv"), OERatiocurve099_lowymax_posfeed_data)
    OERatiocurve099_medymax_posfeed_data = prepDataFrame(finalassets_posfeed_rednoise_dataset_CV(OERatiocurve_vals[3][2,:], EconomicPar(), InterestPar(), CV_posfeed, corrrange_posfeed, maxyears_posfeed, reps_posfeed))
    CSV.write(joinpath(abpath(), "data/OERatiocurve099_medymax_posfeed_data.csv"), OERatiocurve099_medymax_posfeed_data)
    OERatiocurve099_highymax_posfeed_data = prepDataFrame(finalassets_posfeed_rednoise_dataset_CV(OERatiocurve_vals[3][3,:], EconomicPar(), InterestPar(), CV_posfeed, corrrange_posfeed, maxyears_posfeed, reps_posfeed))
