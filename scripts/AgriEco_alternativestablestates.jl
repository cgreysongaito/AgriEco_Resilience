...
let 
    data_hy0hymax_white = cumulativeprob(termprofit_sims_unscaled(100, BMPPar(y0 = 2.0, ymax = 1.5, c = 0.5, p = 2.2), 0.0, 0.1, 50), 0.1)
    data_lyohymax_white = cumulativeprob(termprofit_sims_unscaled(100, BMPPar(y0 = 0.8, ymax = 1.5, c = 0.5, p = 2.2), 0.0, 0.1, 50), 0.1)
    data_hy0lymax_white = cumulativeprob(termprofit_sims_unscaled(100, BMPPar(y0 = 2.0, ymax = 0.8, c = 0.5, p = 2.2), 0.0, 0.1, 50), 0.1)
    data_ly0lymax_white = cumulativeprob(termprofit_sims_unscaled(100, BMPPar(y0 = 0.8, ymax = 0.8, c = 0.5, p = 2.2), 0.0, 0.1, 50), 0.1)
    data_hy0hymax_red = cumulativeprob(termprofit_sims_unscaled(100, BMPPar(y0 = 2.0, ymax = 1.5, c = 0.5, p = 2.2), 0.9, 0.1, 50), 0.1)
    data_lyohymax_red = cumulativeprob(termprofit_sims_unscaled(100, BMPPar(y0 = 0.8, ymax = 1.5, c = 0.5, p = 2.2), 0.9, 0.1, 50), 0.1)
    data_hy0lymax_red = cumulativeprob(termprofit_sims_unscaled(100, BMPPar(y0 = 2.0, ymax = 0.8, c = 0.5, p = 2.2), 0.9, 0.1, 50), 0.1)
    data_ly0lymax_red = cumulativeprob(termprofit_sims_unscaled(100, BMPPar(y0 = 0.8, ymax = 0.8, c = 0.5, p = 2.2), 0.9, 0.1, 50), 0.1)
    cumulativeprobfig = figure()
    subplot(2,2,1)
    plot(data_hy0hymax_white[1], data_hy0hymax_white[2], color="gray")
    plot(data_hy0hymax_red[1], data_hy0hymax_red[2], color="red")
    xlabel("Terminal Profit")
    ylabel("Cumulative Probability")
    subplot(2,2,2)
    plot(data_hy0lymax_white[1], data_hy0lymax_white[2], color="gray")
    plot(data_hy0lymax_red[1], data_hy0lymax_red[2], color="red")
    xlabel("Terminal Profit")
    ylabel("Cumulative Probability")
    subplot(2,2,3)
    plot(data_lyohymax_white[1], data_lyohymax_white[2], color="gray")
    plot(data_lyohymax_red[1], data_lyohymax_red[2], color="red")
    xlabel("Terminal Profit")
    ylabel("Cumulative Probability")
    subplot(2,2,4)
    plot(data_ly0lymax_white[1], data_ly0lymax_white[2], color="gray")
    plot(data_ly0lymax_red[1], data_ly0lymax_red[2], color="red")
    xlabel("Terminal Profit")
    ylabel("Cumulative Probability")
    tight_layout()
    # return cumulativeprobfig
    savefig(joinpath(abpath(), "figs/cumulativeprobfig.png"))
end
