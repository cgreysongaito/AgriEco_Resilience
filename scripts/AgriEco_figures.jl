...
## Positive feedbacks ##
#Figure 3
#Expected terminal assets residual (along OER curve)
let 
    lowymax_099 = expectedterminalassets_residual(OERatiocurve099_lowymax_posfeed_data)
    medymax_099 = expectedterminalassets_residual(OERatiocurve099_medymax_posfeed_data)
    highymax_099 = expectedterminalassets_residual(OERatiocurve099_highymax_posfeed_data)
    lowymax_09 = expectedterminalassets_residual(OERatiocurve09_lowymax_posfeed_data)
    medymax_09 = expectedterminalassets_residual(OERatiocurve09_medymax_posfeed_data)
    highymax_09 = expectedterminalassets_residual(OERatiocurve09_highymax_posfeed_data)
    lowymax_071 = expectedterminalassets_residual(OERatiocurve071_lowymax_posfeed_data)
    medymax_071 = expectedterminalassets_residual(OERatiocurve071_medymax_posfeed_data)
    highymax_071 = expectedterminalassets_residual(OERatiocurve071_highymax_posfeed_data)
    ...
    legend()
    # subplot(2,1,3)
    # plot(lowymax_099[:,1], lowymax_099[:,2], linestyle="solid", color="black", label="Low Ymax")
    # plot(medymax_099[:,1], medymax_099[:,2], linestyle="dashed", color="black", label="Med Ymax")
    # plot(highymax_099[:,1], highymax_099[:,2], linestyle="dotted", color="black", label="High Ymax")
    # title("0.99", fontsize=15)
    # xlabel("Noise correlation", fontsize = 15)
    # ylabel("EFAwNL - EFAwoNL", fontsize = 15)
    # xticks(fontsize=12)
    # yticks(fontsize=12)
...
let 
    lowymax_09 = variabilityterminalassets_rednoise(OERatiocurve09_lowymax_posfeed_data)
    medymax_09 = variabilityterminalassets_rednoise(OERatiocurve09_medymax_posfeed_data)
    highymax_09 = variabilityterminalassets_rednoise(OERatiocurve09_highymax_posfeed_data)
    lowymax_071 = variabilityterminalassets_rednoise(OERatiocurve071_lowymax_posfeed_data)
    medymax_071 = variabilityterminalassets_rednoise(OERatiocurve071_medymax_posfeed_data)
    highymax_071 = variabilityterminalassets_rednoise(OERatiocurve071_highymax_posfeed_data)
...
let 
    lowymax_09 = expectedterminalassets_residual(OERatiocurve09_lowymax_timedelay_data)
    medymax_09 = expectedterminalassets_residual(OERatiocurve09_medymax_timedelay_data)
    highymax_09 = expectedterminalassets_residual(OERatiocurve09_highymax_timedelay_data)
    lowymax_071 = expectedterminalassets_residual(OERatiocurve071_lowymax_timedelay_data)
    medymax_071 = expectedterminalassets_residual(OERatiocurve071_medymax_timedelay_data)
    highymax_071 = expectedterminalassets_residual(OERatiocurve071_highymax_timedelay_data)
...
let 
    lowymax_099 = variabilityterminalassets_rednoise(OERatiocurve099_lowymax_timedelay_data)
    medymax_099 = variabilityterminalassets_rednoise(OERatiocurve099_medymax_timedelay_data)
    highymax_099 = variabilityterminalassets_rednoise(OERatiocurve099_highymax_timedelay_data)
    lowymax_09 = variabilityterminalassets_rednoise(OERatiocurve09_lowymax_timedelay_data)
    medymax_09 = variabilityterminalassets_rednoise(OERatiocurve09_medymax_timedelay_data)
    highymax_09 = variabilityterminalassets_rednoise(OERatiocurve09_highymax_timedelay_data)
    lowymax_071 = variabilityterminalassets_rednoise(OERatiocurve071_lowymax_timedelay_data)
    medymax_071 = variabilityterminalassets_rednoise(OERatiocurve071_medymax_timedelay_data)
    highymax_071 = variabilityterminalassets_rednoise(OERatiocurve071_highymax_timedelay_data)
    ...
    legend()
    subplot(3,1,3)
    plot(lowymax_099[:,1], lowymax_099[:,4].*1.01, linestyle="solid", color="black", label="Low Ymax")
    plot(medymax_099[:,1], medymax_099[:,4], linestyle="dashed", color="black", label="Med Ymax")
    plot(highymax_099[:,1], highymax_099[:,4].*0.99, linestyle="dotted", color="black", label="High Ymax")
    xlabel("Noise correlation", fontsize = 15)
    ylabel("CVwNL/CVwoNL", fontsize = 15)
    xticks(fontsize=12)
    yticks(fontsize=12)
...
let 
    ...
    medymax_071 = variabilityterminalassets_rednoise(OERatiocurve071_medymax_timedelay_data)
    highymax_071 = variabilityterminalassets_rednoise(OERatiocurve071_highymax_timedelay_data)
    varwoNL_OERcurve = figure(figsize=(4,6))    
    subplot(2,1,1)
...
let 
    ...
    medymax_071 = variabilityterminalassets_rednoise(OERatiocurve071_medymax_posfeed_data)
    highymax_071 = variabilityterminalassets_rednoise(OERatiocurve071_highymax_posfeed_data)
    posfeed_varwNL_OERcurve = figure(figsize=(4,6))    
    subplot(2,1,1)
...
let 
    ...
    medymax_071 = variabilityterminalassets_rednoise(OERatiocurve071_medymax_timedelay_data)
    highymax_071 = variabilityterminalassets_rednoise(OERatiocurve071_highymax_timedelay_data)
    timedelays_varwNL_OERcurve = figure(figsize=(4,6))    
    subplot(2,1,1)
    plot(lowymax_071[:,1], lowymax_071[:,2].*1.025, linestyle="solid", color="black", label="Low Ymax")
    plot(medymax_071[:,1], medymax_071[:,2], linestyle="dashed", color="black", label="Med Ymax")
    plot(highymax_071[:,1], highymax_071[:,2].*0.975, linestyle="dotted", color="black", label="High Ymax")
...
#Positive Feedback
let 
    lowymax_099_EFA = expectedterminalassets_residual(OERatiocurve099_lowymax_posfeed_data)
    medymax_099_EFA = expectedterminalassets_residual(OERatiocurve099_medymax_posfeed_data)
    highymax_099_EFA = expectedterminalassets_residual(OERatiocurve099_highymax_posfeed_data)
    lowymax_099_var = variabilityterminalassets_rednoise(OERatiocurve099_lowymax_posfeed_data)
    medymax_099_var = variabilityterminalassets_rednoise(OERatiocurve099_medymax_posfeed_data)
    highymax_099_var = variabilityterminalassets_rednoise(OERatiocurve099_highymax_posfeed_data)
...
#Time Delay
let 
    lowymax_099_EFA = expectedterminalassets_residual(OERatiocurve099_lowymax_timedelay_data)
    medymax_099_EFA = expectedterminalassets_residual(OERatiocurve099_medymax_timedelay_data)
    highymax_099_EFA = expectedterminalassets_residual(OERatiocurve099_highymax_timedelay_data)
    lowymax_099_var = variabilityterminalassets_rednoise(OERatiocurve099_lowymax_timedelay_data)
    medymax_099_var = variabilityterminalassets_rednoise(OERatiocurve099_medymax_timedelay_data)
    highymax_099_var = variabilityterminalassets_rednoise(OERatiocurve099_highymax_timedelay_data)
