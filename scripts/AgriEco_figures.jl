...
let 
    ...
    legend()
    subplot(2,1,2)
    plot(lowymax_133[:,1], lowymax_133[:,3], linestyle="solid", color="black", label="Low Ymax")
    plot(medymax_133[:,1], medymax_133[:,3], linestyle="dashed", color="black", label="Med Ymax")
    plot(highymax_133[:,1], highymax_133[:,3], linestyle="dotted", color="black", label="High Ymax")
    xlabel("Noise correlation", fontsize = 15)
    ylabel("CVwoNL", fontsize = 15)
    xticks(fontsize=12)
    yticks(fontsize=12)
