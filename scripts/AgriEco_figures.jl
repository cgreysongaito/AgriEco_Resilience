...
let 
    ...
    plot(medYmax[:,1], medYmax[:,3], color="#1F968BFF", label="Med Ymax",linewidth = 3)
...
let 
    ...
    plot(medYmax[:,1], medYmax[:,2], color="#1F968BFF", label="Medium Ymax", linewidth = 3)
    plot(highYmax[:,1], highYmax[:,2], color="#73D055FF", label="High Ymax", linewidth = 3)
    xlabel("Relative Profits", fontsize = 15)
...
#Split sd and mean
let 
    lowymax_108 = variabilityterminalassets_breakdown(revexpcurve108_lowymax_posfeed_data)
    medymax_108 = variabilityterminalassets_breakdown(revexpcurve108_medymax_posfeed_data)
    highymax_108 = variabilityterminalassets_breakdown(revexpcurve108_highymax_posfeed_data)
    posfeed_var_changingrevexp = figure()    
    subplot(3,2,1)
    plot(lowymax_108[:,1], lowymax_108[:,2], linestyle="solid", color="black", label="Low Ymax")
    plot(medymax_108[:,1], medymax_108[:,2], linestyle="dashed", color="black", label="Med Ymax")
    plot(highymax_108[:,1], highymax_108[:,2], linestyle="dotted", color="black", label="High Ymax")
    xlabel("Noise correlation", fontsize = 15)
    ylabel("SD wNL", fontsize = 15)
    xticks(fontsize=12)
    yticks(fontsize=12)
    legend()
    subplot(3,2,2)
    ...
    plot(highymax_108[:,1], highymax_108[:,4], linestyle="dotted", color="black", label="High Ymax")
    xlabel("Noise correlation", fontsize = 15)
    ylabel("SD woNL", fontsize = 15)
    xticks(fontsize=12)
    yticks(fontsize=12)
    legend()
    subplot(3,2,3)
    plot(lowymax_108[:,1], lowymax_108[:,3], linestyle="solid", color="black", label="Low Ymax")
    plot(medymax_108[:,1], medymax_108[:,3], linestyle="dashed", color="black", label="Med Ymax")
    plot(highymax_108[:,1], highymax_108[:,3], linestyle="dotted", color="black", label="High Ymax")
    xlabel("Noise correlation", fontsize = 15)
    ylabel("Mean wNL", fontsize = 15)
    xticks(fontsize=12)
    yticks(fontsize=12)
    legend()
    subplot(3,2,4)
    plot(lowymax_108[:,1], lowymax_108[:,5], linestyle="solid", color="black", label="Low Ymax")
    plot(medymax_108[:,1], medymax_108[:,5], linestyle="dashed", color="black", label="Med Ymax")
    plot(highymax_108[:,1], highymax_108[:,5], linestyle="dotted", color="black", label="High Ymax")
    xlabel("Noise correlation", fontsize = 15)
    ylabel("Mean woNL", fontsize = 15)
    xticks(fontsize=12)
    yticks(fontsize=12)
    legend()
    subplot(3,2,5)
    plot(lowymax_108[:,1], lowymax_108[:,6], linestyle="solid", color="black", label="Low Ymax")
    plot(medymax_108[:,1], medymax_108[:,6], linestyle="dashed", color="black", label="Med Ymax")
    plot(highymax_108[:,1], highymax_108[:,6], linestyle="dotted", color="black", label="High Ymax")
    xlabel("Noise correlation", fontsize = 15)
    ylabel("CV wNL", fontsize = 15)
    xticks(fontsize=12)
    yticks(fontsize=12)
    legend()
    subplot(3,2,6)
    plot(lowymax_108[:,1], lowymax_108[:,7], linestyle="solid", color="black", label="Low Ymax")
    plot(medymax_108[:,1], medymax_108[:,7], linestyle="dashed", color="black", label="Med Ymax")
    plot(highymax_108[:,1], highymax_108[:,7], linestyle="dotted", color="black", label="High Ymax")
    xlabel("Noise correlation", fontsize = 15)
    ylabel("CV woNL", fontsize = 15)
    xticks(fontsize=12)
    yticks(fontsize=12)
    legend()
    tight_layout()
