...
## Absolute EFA (with NL)
let #Positive Feedback
    lowymax_09 = expectedfinalassets_absolute(OERatiocurve09_lowymax_posfeed_data)
    medymax_09 = expectedfinalassets_absolute(OERatiocurve09_medymax_posfeed_data)
    highymax_09 = expectedfinalassets_absolute(OERatiocurve09_highymax_posfeed_data)
    lowymax_071 = expectedfinalassets_absolute(OERatiocurve071_lowymax_posfeed_data)
    medymax_071 = expectedfinalassets_absolute(OERatiocurve071_medymax_posfeed_data)
    highymax_071 = expectedfinalassets_absolute(OERatiocurve071_highymax_posfeed_data)
    posfeed_efaabsolute_alongOERatiocurve = figure(figsize=(4,6))    
    subplot(2,1,1)
    plot(lowymax_071[:,1], lowymax_071[:,2], linestyle="solid", color="black", label="Low Ymax")
    plot(medymax_071[:,1], medymax_071[:,2], linestyle="dashed", color="black", label="Med Ymax")
    plot(highymax_071[:,1], highymax_071[:,2], linestyle="dotted", color="black", label="High Ymax")
    ...
    tight_layout()
    # return posfeed_efaresidual_alongOERatiocurve
    savefig(joinpath(abpath(), "figs/posfeed_efaabsolute_alongOERatiocurve.pdf")) 
end

let #Time Delay
    lowymax_09 = expectedfinalassets_absolute(OERatiocurve09_lowymax_timedelay_data)
    medymax_09 = expectedfinalassets_absolute(OERatiocurve09_medymax_timedelay_data)
    highymax_09 = expectedfinalassets_absolute(OERatiocurve09_highymax_timedelay_data)
    lowymax_071 = expectedfinalassets_absolute(OERatiocurve071_lowymax_timedelay_data)
    medymax_071 = expectedfinalassets_absolute(OERatiocurve071_medymax_timedelay_data)
    highymax_071 = expectedfinalassets_absolute(OERatiocurve071_highymax_timedelay_data)
    timedelay_efaresidual_alongOERatiocurve = figure(figsize=(4,6))    
    subplot(2,1,1)
    plot(lowymax_071[:,1], lowymax_071[:,2], linestyle="solid", color="black", label="Low Ymax")
    plot(medymax_071[:,1], medymax_071[:,2], linestyle="dashed", color="black", label="Med Ymax")
    ...
    tight_layout()
    # return timedelay_efaresidual_alongOERatiocurve
    savefig(joinpath(abpath(), "figs/timedelay_efaabsolute_alongOERatiocurve.pdf")) 
end
